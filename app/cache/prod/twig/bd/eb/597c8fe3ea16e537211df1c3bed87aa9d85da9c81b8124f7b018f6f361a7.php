...
";
        // line 2
        if (isset($context["right_menu"])) { $_right_menu_ = $context["right_menu"]; } else { $_right_menu_ = null; }
        $this->env->loadTemplate("LessonStartBundle:Article:right_menu.html.twig")->display(array_merge($context, array("node" => $_right_menu_)));
    }
