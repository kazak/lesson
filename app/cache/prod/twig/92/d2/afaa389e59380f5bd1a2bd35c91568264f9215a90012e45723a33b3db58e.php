...
class __TwigTemplate_92d2afaa389e59380f5bd1a2bd35c91568264f9215a90012e45723a33b3db58e extends Twig_Template
{
...
";
        ...
        if (($this->getAttribute($_admin_, "isGranted", array(0 => "VIEW", 1 => $_object_), "method") && $this->getAttribute($_admin_, "hasRoute", array(0 => "show"), "method"))) {
            // line 13
            echo "    <a href=\"";
            if (isset($context["admin"])) { $_admin_ = $context["admin"]; } else { $_admin_ = null; }
            if (isset($context["object"])) { $_object_ = $context["object"]; } else { $_object_ = null; }
