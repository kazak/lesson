...
class __TwigTemplate_8d00de0e4ca864bf3fcdf5a1b8d0ad638b4c4bd79108d98ced20a08e9a63bff9 extends Twig_Template
{
    ...
    ";
        ...
        if ((($_object_ && $this->getAttribute($_admin_, "hasRoute", array(0 => "edit"), "method")) && $this->getAttribute($_admin_, "isGranted", array(0 => "EDIT"), "method"))) {
            // line 3
            echo "        <a href=\"";
            if (isset($context["admin"])) { $_admin_ = $context["admin"]; } else { $_admin_ = null; }
            if (isset($context["object"])) { $_object_ = $context["object"]; } else { $_object_ = null; }
            if (isset($context["link_parameters"])) { $_link_parameters_ = $context["link_parameters"]; } else { $_link_parameters_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_admin_, "generateObjectUrl", array(0 => "edit", 1 => $_object_, 2 => $_link_parameters_), "method"), "html", null, true);
            echo "\" target=\"new\">";
