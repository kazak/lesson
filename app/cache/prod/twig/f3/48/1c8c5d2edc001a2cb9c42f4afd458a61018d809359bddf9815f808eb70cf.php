...
class __TwigTemplate_f3481c8c5d2edc001a2cb9c42f4afd458a61018d809359bddf9815f808eb70cf extends Twig_Template
{
    ...
    public function block_field($context, array $blocks = array())
    {
        ...
        if (((($this->getAttribute($_field_description_, "hasAssociationAdmin") && $this->getAttribute($this->getAttribute($_field_description_, "associationadmin"), "id", array(0 => $_value_), "method")) && $this->getAttribute($this->getAttribute($_field_description_, "associationadmin"), "isGranted", array(0 => "EDIT", 1 => $_value_), "method")) && $this->getAttribute($this->getAttribute($_field_description_, "associationadmin"), "hasRoute", array(0 => "edit"), "method"))) {
            // line 16
            echo "        <a href=\"";
            if (isset($context["field_description"])) { $_field_description_ = $context["field_description"]; } else { $_field_description_ = null; }
            if (isset($context["value"])) { $_value_ = $context["value"]; } else { $_value_ = null; }
